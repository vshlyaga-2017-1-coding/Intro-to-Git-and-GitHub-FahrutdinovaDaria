...
* Помимо структуры папок и файлов, самым заметным элементом в репозитории является файл README. Если его нет, то страницы выглядит странно. Каждый обязан добавить README в свой репозиторий.
